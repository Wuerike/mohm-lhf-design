...
"}")
        ...
        self.main_home_button.clicked.connect(self.main.raise)
        self.main_menu_button.clicked.connect(self.menu.raise)
        self.main_setup_button.clicked.connect(self.setup.raise)
        self.menu_config_button.clicked.connect(self.config.raise)
        self.menu_calib_button.clicked.connect(self.calib.raise)
        self.menu_com_button.clicked.connect(self.comunication.raise)
        self.calib_back_button.clicked.connect(self.menu.raise)
        self.com_back_button.clicked.connect(self.menu.raise)
        self.config_back_button.clicked.connect(self.menu.raise)
